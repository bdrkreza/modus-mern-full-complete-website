...
const Sidebar = ({
    ...
    return (
        <>
            <div class="h-full p-3  space-y-2 w-64 md:w-16 bg-gray-900 text-gray-800 lg:w-64 z-30">
                {/* Sidebar header */}
                ...
                <div id="sidebar"
                    className={`absolute  z-50 left-0 top-0 lg:static lg:left-auto lg:top-auto lg:translate-x-0 transform h-screen lg:overflow-y-auto no-scrollbar w-64 flex-shrink-0 bg-gray-800 max-h-full  p-4 transition-transform duration-200 ease-in-out ${sidebarOpen ? 'translate-x-0' : '-translate-x-64'}`}>

                    <div className="flex justify-between mb-4 pr-3 sm:px-2">
                        {/* Close button */}
                        <button
                            className="lg:hidden text-gray-100 hover:text-gray-400 animate-pulse"
                    ...
                    <div class="flex items-center p-1 mb-2 space-x-4">
                        {
                            user ? <img
                                src={user?.photoUrl}
                                alt=""
                                class="w-12 h-12 rounded-full"
                            /> : <FontAwesomeIcon class="w-12 h-12 text-white rounded-full" icon={faUser} />
                        }
                        <div>
                            ...
                            <span class="flex items-center space-x-1">
                                <Link onClick={e => {
                                    e.preventDefault();
                                    setOpenTab(6);
                                }} class="text-md hover:underline text-gray-600">
                                    View profile
                                </Link>
                            </span>
                        </div>
                    ...
                    <div class="divide-y divide-gray-300 ">
                        <ul class="pt-2 pb-4 space-y-1 text-sm">
                            <li className={
                                "text-xs font-bold uppercase px-5 py-1 shadow rounded block leading-normal hover:text-white hover:bg-yellow-900 " +
                                (openTab === 1
                                ...
                                <Link onClick={e => {
                                    e.preventDefault();
                                    setOpenTab(1);
                                }} href="#" class="flex items-center p-2 space-x-3 rounded-md"
                            ...
                            <li className={
                                "text-xs font-bold uppercase px-5 py-1 shadow rounded block hover:text-white leading-normal hover:bg-yellow-900 " +
                        ...
                        <ul class="pt-4 pb-2 space-y-1 text-sm">
                            ...
                            <li className={
                                ...
                                <Link onClick={signOut} to="/home" class="flex items-center p-2 space-x-3 rounded-md">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 512 512"
                                        class="w-5 h-5 fill-current text-gray-300"
