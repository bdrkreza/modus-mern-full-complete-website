                    ...
                    <div class="max-w-sm m-auto">
                        <div class="border-t-4 border-teal-100 overflow-hidden rounded shadow-md">
                                ...
                                <form onSubmit={handleSubmit(onSubmit)} class="flex flex-col items-center">
                                    ...
                                    <div class="px-0 mb-4 flex">
                                        <div class="w-1/1">
                                            ...
                                            <label for="remember-me" class="align-middle text-grey-dark text-md cursor-pointer "> I accept the
                                                <a href="/" className="text-green-600"> Terms of User
                                                    <abbr className="text-black ml-1 mr-1">
                                                        &
                                                    </abbr>
                                                    Privacy Policy
                                                </a>
                            ...
                            <div class="bg-grey-lighter text-center text-grey-dark py-4 mt-3">
                                Already have an account? <Link to="/signIn" class="font-semibold text-lg no-underline text-yellow-800">Login here</Link>
                            </div>
                        </div>
                    </div>

                    {/* Sign in  with media */}
                    <div class="text-center text-xl text-gray-900 py-4">
                        Sign in with
                    </div>
