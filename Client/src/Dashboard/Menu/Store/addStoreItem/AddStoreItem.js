                            ...
                            <div class="w-full lg:w-1/1 bg-white p-2 rounded-lg lg:rounded-l-none">
                                ...
                                <form onSubmit={handleSubmit(onSubmit)} class="px-8 pt-6 pb-8 mb-4 bg-white rounded">
                                    ...
                                    <div className="text-center">
                                        <select className="text-2xl" {...register("catagories")}>
                                            <option value="arrivalItem">arrivalItem</option>
                                            <option value="futureItem">futureItem</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="grid grid-cols-1 space-y-2 mt-2">
                                        ...
                                        <input {...register("price", { required: true })} class="text-base p-2 border border-gray-300 rounded-lg focus:outline-none focus:border-indigo-500" type="number" placeholder="Product Price" />
                                        {errors.price && <span className="text-red-500">Product price is required</span>}
                                    </div>

                                    <div class="grid grid-cols-1 space-y-2 mt-2">
                                        <label class="text-sm font-bold text-gray-500 tracking-wide">Product Code</label>
                                        <input {...register("id", { required: true })} class="text-base p-2 border border-gray-300 rounded-lg focus:outline-none focus:border-indigo-500" type="number" placeholder="Enter product code" />
                                        {errors.id && <span className="text-red-500">Product price is required</span>}
                                    </div>

                                    <div class="flex justify-between mt-2">
                                        <div>
                                            <label class="text-md font-bold text-gray-500 mr-2 tracking-wide">Quantity</label>
                                            <input {...register("qty", { required: true })} class="text-base p-2 border border-gray-300 rounded-lg focus:outline-none focus:border-indigo-500" type="number" placeholder="Quantity" />
                                            {errors.qty && <span className="text-red-500"> product Size is required</span>}
                                        </div>
                                        <div className="">
                                            <label class="text-md mr-2 font-bold text-gray-500 tracking-wide">Size</label>
                                            <select className="text-xl" {...register("size")}>
