...
function TopChannel() {
    return (
        <div className="col-span-full xl:col-span-8 backgroundColor shadow-lg rounded-sm border border-gray-200">
            <header className="px-5 py-4 border-b border-gray-100">
                <h2 className="font-semibold text-2xl text-center text-gray-400">Top Channels</h2>
            </header>
            <div className="p-3">
                ...
                <div className="overflow-x-auto">
                    <table className="table-auto text-gray-300 w-full">
                        {/* Table header */}
                        <thead className="text-1xl font-semibold uppercase text-gray-400 bg-gray-50 sm:rounded-lg">
                            <tr>
                                <th className="p-2">
                            ...
                            <tr>
                                <td className="p-2">
                                    <div className="flex items-center">
                                        ...
                                        <div className="text-gray-400">Github.com</div>
                                    </div>
                                </td>
                                <td className="p-2">
                                ...
                                <td className="p-2">
                                    <div className="text-center text-green-400">$3,877</div>
                                </td>
                                <td className="p-2">
                            ...
                            <tr>
                                <td className="p-2">
                                    <div className="flex items-center">
                                        ...
                                        <div className="text-gray-400">Google (organic)</div>
                                    </div>
                                </td>
                                <td className="p-2">
                            ...
                            <tr>
                                <td className="p-2">
                                    <div className="flex items-center">
                                        ...
                                        <div className="text-gray-400">Vimeo.com</div>
                                    </div>
                                </td>
                                <td className="p-2">
                            ...
                            <tr>
                                <td className="p-2">
                                    <div className="flex items-center">
                                        ...
                                        <div className="text-gray-400">Indiehackers.com</div>
                                    </div>
                                </td>
                                <td className="p-2">
