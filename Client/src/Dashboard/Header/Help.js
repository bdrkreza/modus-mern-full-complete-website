...
function Help() {
  ...
  return (
    <div className="relative inline-flex ml-3">
      ...
      <Transition
        className="origin-top-right z-10 absolute top-full right-0 min-w-44 bg-white border border-gray-200 py-1.5 px-8 rounded shadow-lg overflow-hidden mt-3"
        show={dropdownOpen}
      ...
      >
        ...
        >
          <div className="text-xs font-semibold text-gray-400 uppercase  pt-3.5 pb-5 px-4">Need help?</div>
          <ul>
            <li>
              <Link
