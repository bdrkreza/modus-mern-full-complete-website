                ...
                <div class="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-3">
                    {
                        blog.map((data) =>
                            <div className="text-center">
                                ...
                                <a href="/" class="bg-white transition duration-500 ease-in-out transform  mt-12 ml-60 hover:bg-yellow-600 text-gray-800 font-semibold py-2 px-1 border grid lg:grid-cols-1 border-gray-400 rounded shadow">
                                    Read More
                                </a>
                            </div>
