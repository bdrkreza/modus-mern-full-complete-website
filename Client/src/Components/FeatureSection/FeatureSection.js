...
const FeatureSection = () => {
  return (
    <>
      <div class="container  items-center mx-auto mt-5 py-16">
        <div class=" w-8/12 text-center grid lg:grid-cols-3 md:grid-cols-2 sm:gird-cols-1 gap-6 mx-auto justify-center">
