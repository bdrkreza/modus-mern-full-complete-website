...
export default function Navbar({ sidebar, setSidebar }) {
  ...
  useEffect(() => {
    fetch("https://rkmodus.herokuapp.com/isAdmin", {
      method: "POST",
  ...
  return (
    <Disclosure as="nav" className="  bg-blue-300 z-50">
      {({ open }) => (
        <>
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                <>
                  <button
                    ...
                    className="bg-gray-800 flex text-sm ml-10 text-white rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white"
                  >
                    ...
                    <span className="absolute h-20 w-10 mt-2 text-2xl text-red-500">
                      {product.length}
                    </span>
                  </button>
