...
const CheckProduct = ({ product }) => {
    const { product_price, product_name, product_image } = product;
    const dispatch = useDispatch();
    return (
        <>
            <ul className="flex flex-col divide-y divide-coolGray-300 px-3">
                <li className="flex flex-col py-6 sm:flex-row sm:justify-between">
                    <div className="flex w-full space-x-2 sm:space-x-4 divide-y divide-yellow-500">
                        <img className="flex-shrink-0 object-cover w-20 h-20 border-transparent rounded outline-none sm:w-32 sm:h-32" src={product_image} alt="product_image" />
                        <div className="flex flex-col justify-between w-full pb-4">
                            <div className="flex justify-between w-full pb-2 space-x-2">
                                ...
                                <div className="text-right">
                                    <p className="text-lg font-semibold">{product_price}€</p>
