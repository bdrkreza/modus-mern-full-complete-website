...
const PaymentInfo = ({ handlePaymentSuccess }) => {
    ...
    return (
        <div>
            <div class="min-w-screen min-h-screen bg-gray-200 flex items-center justify-center px-16 pb-20">
                <div class="w-full mx-auto rounded-lg bg-white shadow-lg p-5 text-gray-700" style={{ maxWidth: "600px" }}>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <h1 className="text-center text-lg text-red-500 mb-2">{error}</h1>
                        <div>
                            {
                                Success ?
                                    <PaymentSuccess /> : <button
                                        ...
                                        {processing && <div className="flex text-blue-300 items-center justify-center">
                                            <span class="animate-spin rounded-full  h-4 w-4 border-t-2 border-b-2 border-gray-100 mt-1 mr-2"></span>
                                            processing..
                                        </div>}
